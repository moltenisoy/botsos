"""
BotSOS-LMStudio - Administrador de Automatización de YouTube Multi-Sesión.
...
- Integración con LM Studio (API compatible con OpenAI).
...
__version__ = "1.0.0"
__author__ = "BotSOS-LMStudio Team"
...
# Cliente LM Studio
from .lmstudio_client import LMStudioClient, LMStudioConfig, get_lmstudio_client, check_lmstudio_connection
